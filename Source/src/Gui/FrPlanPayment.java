...
public class FrPlanPayment extends javax.swing.JFrame {
    ...
    public FrPlanPayment(String lai, int kymin, int kymax, double gocmax) {
        ...
        initComponents();
        txtPeriod.setModel(new javax.swing.SpinnerNumberModel(kymin, kymin, kymax, 1));
        txtgoc.setModel(new javax.swing.SpinnerNumberModel(0, 0, gocmax, 10000));
        txtInterestRate.setText(lai);
    ...
    private void initComponents() {
        ...
        txtPeriod = new javax.swing.JSpinner();
        ...
        txtPeriod.setModel(new javax.swing.SpinnerNumberModel(20, 20, 50, 1));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtInterestRate, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtPeriod, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void btnKiemtraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKiemtraActionPerformed
        double loanAmount = 0, principal, remainingAmount = 0, interestRate, interestCharged, monthlyAmount;
        int period;
        ...
        loanAmount = (double) txtgoc.getValue();
        interestRate = Double.parseDouble(txtInterestRate.getText());
        period = (int) txtPeriod.getValue();
        //Calculation TODO
        
        
        principal = loanAmount / (double) period;
        remainingAmount = loanAmount - remainingAmount;
        interestCharged = remainingAmount * (interestRate / 100) / 12;
        monthlyAmount = principal + interestCharged;
       

        PlanPayment a = new PlanPayment(1, principal, remainingAmount, interestCharged, monthlyAmount);
        ...
        for (int i = 1; i < period; i++) {
            ...
            PlanPayment bb = new PlanPayment(i + 1, principal, remainingAmount, interestCharged, monthlyAmount);
    ...
    private javax.swing.JSpinner txtPeriod;
